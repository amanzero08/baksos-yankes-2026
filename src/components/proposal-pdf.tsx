...
const t = {
  id: {
    ...
    loveDonor: "Donatur Pelayanan Kasih",
    ...
    pointADesc: "Kecamatan Ratahan Timur, Kabupaten Minahasa Tenggara",
    pointB: "Lokasi II",
    pointBDesc: "Desa Likupang 2, Kecamatan Likupang Timur, Kabupaten Minahasa Utara (Pusat Sunatan Massal)",
    pointC: "Lokasi III",
    pointCDesc: "Kelurahan Lansot, Kecamatan Tomohon Selatan, Kota Tomohon",

    sec4Num: "IV.",
    sec4Title: "Letak Geografis & Demografi Lokasi",
    tondanouwTitle: "Ratahan Timur (Mitra)",
    tondanouwDesc: "Ratahan Timur adalah sebuah kecamatan di Kabupaten Minahasa Tenggara yang memiliki potensi besar dalam sektor pertanian dan perkebunan. Dengan tradisi gotong royong Mapalus yang kuat, sebagian besar warga berprofesi sebagai petani sawah dan perkebunan, menjadikannya salah satu sentra produksi di Minahasa Tenggara.",
    likupangTitle: "Desa Likupang 2 (Minut)",
    likupangDesc: "Desa Likupang 2 terletak di Kecamatan Likupang Timur, ujung utara Pulau Sulawesi, berjarak sekitar 60 km dari Manado. Daerah pesisir Likupang Timur dikenal sebagai destinasi prioritas, di mana sebagian besar masyarakat bekerja sebagai nelayan, petani, dan pelaku pariwisata. Wilayah strategis ini memiliki tantangan kesehatan tersendiri akibat jarak dari pusat rujukan medis.",
    lolahTitle: "Kel. Lansot (Tomohon)",
    lolahDesc: "Kelurahan Lansot terletak di Kecamatan Tomohon Selatan, Kota Tomohon, sebuah daerah dengan hawa sejuk yang merupakan pusat aktivitas warga. Komunitas di Lansot sangat menjunjung tinggi kebersamaan dan kerukunan. Wilayah ini dihuni oleh masyarakat yang ramah, aktif dalam berbagai kegiatan keagamaan, sosial, serta usaha pertanian lokal.",
  ...
  en: {
    ...
    loveDonor: "Donor of Love Ministry",
    ...
    pointADesc: "East Ratahan District, Southeast Minahasa Regency",
    pointB: "Location II",
    pointBDesc: "Likupang 2 Village, East Likupang District, North Minahasa (Mass Circumcision Center)",
    pointC: "Location III",
    pointCDesc: "Lansot Sub-district, South Tomohon District, Tomohon City",

    sec4Num: "IV.",
    sec4Title: "Geographic Location and Demography of Locations",
    tondanouwTitle: "East Ratahan (Mitra)",
    tondanouwDesc: "East Ratahan is a district in Southeast Minahasa Regency with great potential in the agriculture and plantation sectors. With a strong Mapalus mutual cooperation tradition, the majority of residents are farmers, making it a production center in Southeast Minahasa.",
    likupangTitle: "Likupang 2 Village (Minut)",
    likupangDesc: "Likupang 2 Village is located in East Likupang District, at the northern tip of Sulawesi. The coastal area of East Likupang is known as a priority destination where many work as fishermen, farmers, and in tourism. This region faces unique healthcare challenges due to its distance from referral hospitals.",
    lolahTitle: "Lansot Sub-district (Tomohon)",
    lolahDesc: "Lansot Sub-district is located in South Tomohon District, Tomohon City, an area with a cool climate. The community in Lansot highly values togetherness and harmony, actively participating in religious and social activities, alongside local agricultural endeavors.",
